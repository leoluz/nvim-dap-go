...
local function debug_test(testname, testpath, args, build_flags)
    local dap = load_module("dap")
...
function M.debug_last_test()
    ...
    vim.notify(msg)
    debug_test(testname, testpath, testargs, M.test_buildflags)
